...
class WindowsPrivatePackagingContractTests(unittest.TestCase):
    ...
    def test_native_ui_does_not_persist_source_access_or_swallow_fatal_errors(self) -> None:
        ...
        self.assertNotIn("ios_encrypted_backup", main_window)
        self.assertNotIn("ios_encrypted_backup", xaml)
        self.assertIn("Encrypted iOS recovery is not available", support)
